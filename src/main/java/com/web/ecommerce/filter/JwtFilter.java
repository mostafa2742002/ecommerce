package com.web.ecommerce.filter;
...
import com.web.ecommerce.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        return path.startsWith("/webjars") || path.startsWith("/index.html") || path.startsWith("/signup")
                ...
                path.equals("/") || path.equals("/welcome.html") || path.startsWith("/blog") || path.startsWith("/home/refreshtoken") || path.startsWith("/home");
    }
